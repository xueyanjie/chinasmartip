...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <h3 class="page-header">抽奖活动管理</h3>
            <div style="margin:10px;">
                <button id="btnAddAction" class="btn btn-primary" type="button" data-toggle="modal" data-target="#win_edit">新增抽奖活动</button>
            </div>
...
<!--                        <td>创建时间</td>-->
                ...
                if (isset($list) && !empty($list)) {
                    foreach ($list as $item) {
                        echo '<tr>';
                        echo '<td>' . $item['action_id'] . '</td>';
                        echo '<td>' . $item['title'] . '</td>';
                        echo '<td>' . $item['start_time'] . '</td>';
                        echo '<td>' . $item['end_time'] . '</td>';
                        echo '<td>' . $item['one_day_draw_num'] . '</td>';
                        echo '<td>' . $item['one_day_win_num'] . '</td>';
                        echo '<td>' . $item['one_cycle_win_num'] . '</td>';
                        echo '<td>' . $item['risk_control_switch'] . '</td>';
